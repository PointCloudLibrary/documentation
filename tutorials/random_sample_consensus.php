...
<p>Again hit ‘r’ to scale and center the view and then click and drag with the mouse to rotate around the cloud.  You can see there are no longer any points that do not lie within the plane model in this PointCloud. Hit ‘q’ to exit the viewer and program.</p>
...
<p>It will generate and display a spherical cloud and some outliers as well.</p>
