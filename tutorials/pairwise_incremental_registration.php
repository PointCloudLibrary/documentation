...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/memory.h&gt;  // for pcl::make_shared</span><span class="cp"></span>
...
<span class="p">{</span>
  ...
  <span class="n">reg</span><span class="p">.</span><span class="n">setPointRepresentation</span> <span class="p">(</span><span class="n">pcl</span><span class="o">::</span><span class="n">make_shared</span><span class="o">&lt;</span><span class="k">const</span> <span class="n">MyPointRepresentation</span><span class="o">&gt;</span> <span class="p">(</span><span class="n">point_representation</span><span class="p">));</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;pcl/memory.h&gt;  // for pcl::make_shared</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_types.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_cloud.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_representation.h&gt;</span><span class="cp"></span>
